...
class DeepScanner:
    ...
    def analyze_deep_with_ai(self, stock_name, price, volume, market):
        prompt = (
            ...
            "당신은 매우 보수적이고 냉철한 전문 투자 전략가입니다. 아래 지침을 엄수하세요:\n"
            "1. 대부분의 종목은 중립(0.0) 근처로 평가하십시오.\n"
            "2. 긍정적인 요소보다 리스크(고점 부담, 거래량 급감, 매크로 악재 등)를 먼저 찾아 점수를 감점하세요.\n"
            "3. 0.8(80점) 이상은 시장 주도주 급의 확실한 근거가 있을 때만 매우 드물게 부여합니다.\n"
            "4. JSON 형식으로만 응답: {\"score\": 0.15, \"summary\": \"요약\", \"tech\": \"기술적분석\", \"ext\": \"대외전망\"}\n"
            "5. 점수(score)는 -1.0(악재 폭발)에서 1.0(호재 폭발) 사이이며, 소수점 둘째자리까지 정교하게 산출하세요."
        )
